...
const SCREEN_MAP = {
  ...
  'spend-analytics':    (nav, roleKey, ctx) => React.createElement(SpendAnalyticsScreen,    { onNavigate: nav }),
  'working-capital':    (nav, roleKey, ctx) => React.createElement(WorkingCapitalScreen,    { onNavigate: nav }),
  'vendor-risk':        (nav, roleKey, ctx) => React.createElement(VendorRiskScreen,        { onNavigate: nav }),
  'gst-recon':          (nav, roleKey, ctx) => React.createElement(GSTReconScreen,          { onNavigate: nav }),
  'tds-compliance':     (nav, roleKey, ctx) => React.createElement(TDSComplianceScreen,     { onNavigate: nav }),
  'policy-compliance':  (nav, roleKey, ctx) => React.createElement(PolicyComplianceScreen,  { onNavigate: nav }),
  'dept-variance':      (nav, roleKey, ctx) => React.createElement(DeptVarianceScreen,      { onNavigate: nav }),
  'po-match':           (nav, roleKey, ctx) => React.createElement(POMatchScreen,           { onNavigate: nav }),
};
