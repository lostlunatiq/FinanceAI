...
const SCREEN_MAP = {
  ...
  'ar-customer':        (nav, roleKey, ctx) => React.createElement(ARCustomerScreen,        { role: roleKey, onNavigate: nav }),
  'reports':            (nav, roleKey, ctx) => React.createElement(ReportsScreen,           { role: roleKey, onNavigate: nav }),
