    ...
    <div style={{ padding: '32px 32px 100px', position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 180px 180px', gap: '16px', animation: 'fadeUp 300ms 320ms ease both', opacity: 0, animationFillMode: 'forwards' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', gridColumn: 'span 2' }}>
          {/* Cards container — both align at same height */}
          <div style={{ display: 'flex', gap: '12px' }}>
            <div onClick={runLoading.q ? undefined : handleGenerate10Q}
              style={{ flex: 1, background: runLoading.q ? '#F8F7F5' : 'white', borderRadius: '16px', padding: '22px 20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', cursor: runLoading.q ? 'wait' : 'pointer', opacity: runLoading.q ? 0.7 : 1, transition: 'all 200ms' }}
            ...
            <div onClick={runLoading.sweep ? undefined : handleAuditSweep}
              style={{ flex: 1, background: runLoading.sweep ? '#F8F7F5' : 'white', borderRadius: '16px', padding: '22px 20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', cursor: runLoading.sweep ? 'wait' : 'pointer', opacity: runLoading.sweep ? 0.7 : 1, transition: 'all 200ms' }}
